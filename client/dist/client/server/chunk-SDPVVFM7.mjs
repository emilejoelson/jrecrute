...
import{n as k,o as A,q as G}from"./chunk-NJRJKORO.mjs";import{$b as y,Ab as u,Mb as p,Ob as b,Wb as t,Xb as i,Yb as o,Zb as C,_b as h,ac as w,bc as c,db as g,fc as a,gc as S,ic as _,kb as s,nc as E,ub as v,va as f,wa as x,xa as d,ya as m}from"./chunk-PMVEATU5.mjs";import"./chunk-X2SEQXRR.mjs";var V=()=>[1,2,3,4,5,6,7,8,9];function j(l,n){if(l&1&&o(0,"div",27),l&2){let e=c().$implicit,r=c();p("innerHTML",r.getArticleContent(e),g)}}function F(l,n){if(l&1){let e=y();C(0),t(1,"div",18)(2,"button",19),w("click",function(){let M=f(e).$implicit,T=c();return x(T.toggleArticle(M))}),t(3,"div",20)(4,"div",21)(5,"span",22),a(6),i()(),t(7,"span",23),a(8),i()(),d(),t(9,"svg",24),o(10,"path",25),i()(),u(11,j,1,1,"div",26),i(),h()}if(l&2){let e=n.$implicit,r=c();s(6),S(e),s(2),_("Article ",e," - ",r.getArticleTitle(e),""),s(),b("rotate-180",r.isArticleExpanded(e)),s(2),p("ngIf",r.isArticleExpanded(e))}}var L=class l{expandedArticles={};toggleArticle(n){this.expandedArticles[n]=!this.expandedArticles[n]}isArticleExpanded(n){return this.expandedArticles[n]||!1}getArticleTitle(n){return{1:"Description du service",2:"Conditions financi\xE8res",3:"Lancement de la prestation",4:"Facturation",5:"Garantie de remplacement",6:"Engagement de l'entreprise",7:"Confidentialit\xE9 et usage des donn\xE9es",8:"Droit applicable",9:"Acceptation des CGV"}[n]||""}getArticleContent(n){return{1:`
        <div class="space-y-4">
