import{l as A,m as L,o as k}from"./chunk-QCKORCBF.js";import{$b as C,Aa as f,Ba as d,Ca as p,Cb as u,Mb as m,Ob as b,Wb as n,Xb as e,Yb as o,Zb as y,_b as h,ac as E,bc as c,fb as g,fc as t,gc as S,ic as _,mb as s,nc as w,wb as v,za as x}from"./chunk-OZJJMYSU.js";var P=()=>[1,2,3,4,5,6,7,8,9];function V(a,l){if(a&1&&o(0,"div",31),a&2){let i=c().$implicit,r=c();m("innerHTML",r.getArticleContent(i),g)}}function G(a,l){if(a&1){let i=C();y(0),n(1,"div",22)(2,"button",23),E("click",function(){let N=x(i).$implicit,T=c();return f(T.toggleArticle(N))}),n(3,"div",24)(4,"div",25)(5,"span",26),t(6),e()(),n(7,"span",27),t(8),e()(),d(),n(9,"svg",28),o(10,"path",29),e()(),u(11,V,1,1,"div",30),e(),h()}if(a&2){let i=l.$implicit,r=c();s(6),S(i),s(2),_("Article ",i," - ",r.getArticleTitle(i),""),s(),b("rotate-180",r.isArticleExpanded(i)),s(2),m("ngIf",r.isArticleExpanded(i))}}var M=class a{expandedArticles={};toggleArticle(l){this.expandedArticles[l]=!this.expandedArticles[l]}isArticleExpanded(l){return this.expandedArticles[l]||!1}getArticleTitle(l){return{1:"Description du service",2:"Conditions financi\xE8res",3:"Lancement de la prestation",4:"Facturation",5:"Garantie de remplacement",6:"Engagement de l'entreprise",7:"Confidentialit\xE9 et usage des donn\xE9es",8:"Droit applicable",9:"Acceptation des CGV"}[l]||""}getArticleContent(l){return{1:`
        <div class="space-y-4">
